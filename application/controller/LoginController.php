...
class LoginController extends Controller
{
    ...
    public function login()
    {
        ...
        // check login status: if true, then redirect user dashboard, if false, then to login form again
        if ($login_successful) {
    ...
    public function logout()
    {
        if (!Request::post('csrf_token')) {
           $this->View->render('login/logout', array(
    ...
    {
        Auth::checkAuthentication();
        $this->View->render('login/editUsername', array(
            'user_name' => Session::get('user_name'),
            'user_email' => Session::get('user_email'),
            'user_gravatar_image_url' => Session::get('user_gravatar_image_url'),
            'user_avatar_file' => Session::get('user_avatar_file'),
    ...
    public function editUsername_action()
    {
        ...
        Redirect::to('login/editusername');
    }
    ...
    {
        Auth::checkAuthentication();
        $this->View->render('login/editUserEmail', array(
		'user_name' => Session::get('user_name'),
		'user_email' => Session::get('user_email'),
		'user_gravatar_image_url' => Session::get('user_gravatar_image_url'),
		'user_avatar_file' => Session::get('user_avatar_file'),
