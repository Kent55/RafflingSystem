  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      ...
      <!-- column 2 -->	
       ...
       <!-- <div class="col-md-7">
			  <div class="well">Latest News <span class="badge pull-right">3</span></div>
	   ...
	   <div class="row">
            <!-- center left-->	
         	<div class="col-md-7">
			  <div class="well"><strong>Latest News: </strong> Enter raffle now for Swindon vs Bristol.</div>
        	...
        	<p>
                  Welcome <strong><?php echo $this->user_name;?></strong>, this is you personal dashboard. From here you can manage all aspects of your account.
                </p>
                <p>
                  The dropdown at the top of the page allows you to modify your account. The links on the left hand column of this page
                  allow you to manage your raffle tickets, winnings and also the option to deactivate your account.
                </p>
                <p>If you need any assistance please email us at: <a href="">support@swindonraffle.co.uk</a>. For information on deativating
                your account click <a href="">here</a>.</p>
